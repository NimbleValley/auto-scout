...
const getInfo = require('@distube/ytdl-core/lib/info.cjs');
const utils = require('@distube/ytdl-core/lib/utils.cjs');
const formatUtils = require('./format-utils');
const urlUtils = require('@distube/ytdl-core/lib/url-utils.cjs');
const sig = require('@distube/ytdl-core/lib/sig.cjs');
...
ytdl.version = require('@distube/ytdl-core/package.json').version;
